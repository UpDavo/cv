								...
								<div className="container mt-5">
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Crafting visually appealing and user-friendly interfaces using <span className="text-secondary-2">HTML</span>, <span className="text-secondary-2">CSS</span>, <span className="text-secondary-2">JavaScript</span>, <span className="text-secondary-2">Python</span>, and modern frameworks like React, Angular and Django.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Creating and integrating <span className="text-secondary-2">RESTful APIs</span> to enable smooth communication between front-end and back-end systems usin technologies such as <span className="text-secondary-2">Django</span> and <span className="text-secondary-2">NestJS</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Improving the speed and performance of web applications to provide a better user experience. Work with <span className="text-secondary-2">Nodejs</span>, <span className="text-secondary-2">Express</span>, <span className="text-secondary-2">Fabric</span></p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Developing scalable and secure payment integrations for <span className="text-secondary-2">e-commerce platforms</span> tailored to your business needs.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
									...
									<div className="text-center pt-60">
										<p className="text-300">
											...
											Let's chat about your ideas. <Link href="#contact" className="text-primary-2">Reach out!</Link>
										</p>
									</div>
								</div>
							</div>
